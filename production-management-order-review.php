...
if(isset($_POST['filter_submit'])){
    ...
    $ordered_sum=$query_guy->run_order_sum_search();//filtering function..my special function
    $sum_results=mysqli_fetch_assoc($ordered_sum);
    $ordered_total=$sum_results['ORDERED_TOTAL'];

    if($ordered_total==""){$ordered_total="No Orders";}
	...
	if(mysqli_num_rows($filter_results)==0){ $order_rows='<tr><td><b>No orders found for your filter</b></td></tr>';}
       ...
       $sum_total="SELECT SUM(ORDERED_QUANTITY) AS ORDERED_TOTAL FROM ORDERS";
       $sum_process=mysqli_query(DB_Connection::$connection,$sum_total);
       $sum_results=mysqli_fetch_assoc($sum_process);
       $ordered_total=$sum_results['ORDERED_TOTAL'];
...
<link rel="stylesheet" href="css/production-management-order-review.css"/>
...
<body>
 ...
 <nav class="navbar navbar-inverse navbar-fixed-right">
        ...
        <ul class="nav navbar-nav">
        	 <li><a href="production-view"><i class="fa fa-arrow-left"></i> Back To Overall For Today</a></li>
...
<div class="row">
	...
	<h4>Total Ordered Quantity: <b><?php echo $ordered_total; ?></b> </h4>	
	  <div class="sidebox">
